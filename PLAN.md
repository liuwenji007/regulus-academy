...
- [x] **划词助教** — 教练页划词解术语/读音/短发散；`knowledge_gaps` 账本（划词前置 + 错题 + 跳级）；注入教练提示与侧栏「今日推荐」缺口源；不写主线 sessions/进度
...
- [ ] **划词助教演示动图** — `aside-selection.gif` / `aside-panel.png` 入库（见 `docs/screenshots/README.md`）
