...
不是"AI 家教"，不是"智能课堂"，而是一个教练——知道你在哪、记得你已会什么、只纠正你最该纠正的那一个动作、按你的节奏在 15 分钟内完成一个可测量的进步。
...
**越学越懂你：** 丢弃固定课表，随着学习持续更新你的画像——知道你已会什么、卡在哪、想往哪走。建课按背景裁剪公共 Skill，讲解跳过冗余、聚焦缺口；节点完成后纵深扩展也基于现有掌握向外生长，练习题型与难度随之调整。学得越久，路径越贴你，时间花在刀刃上。
...
3. **从通用到专属** — 冷启动画像 + 每节对话回顾，让教练记住你的背景与薄弱点；下次讲解自动注入，出题与点亮标准也更有针对性。同一套 Skill，不同人走不同路径，效率随学习次数递增。
...
| 痛点 | 时间碎片化、学了开头学不完、不知道自己是否真的"会了"、通用教程重复讲已会内容 |
| 需求 | 一个有边界的知识地图 + 一个越学越懂你、按现有知识拓展并针对性训练的教练 |
| 场景 | 通勤、午休、下班后的零散时间 |
...
- **越学越懂你**，画像随对话更新：建课裁剪、讲解跳过冗余、纵深扩展按现有掌握向外生长，练习只打薄弱点，碎片时间效率更高
